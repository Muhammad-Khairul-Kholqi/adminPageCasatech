            ...
            <div className="bg-white p-[20px] rounded-[10px] mt-[20px]">
                    ...
                    <form>
                        ...
                        <div className = "mt-[15px]" >
                            ...
                            <br />
                            <input className="w-full mt-[10px] border-solid border-2 border-gray-600 rounded-[3px]" type="text" id="software" />
                        </div>
                        <div className = "mt-[15px]" >
                            <span for="amount">Amount:</span>
                            <br />
                            <input className="w-full mt-[10px] border-solid border-2 border-gray-600 rounded-[3px]" type="number" id="amount" />
                        </div>
                        <div className = "mt-[15px]" >
