    ...
    const handleDelete = async () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    await Promise.all(selectedItems.map(id => axios.delete(`http://localhost:4000/portfolio/${id}`)));
        ...
        <div>
            <div className = "container bg-cover bg-center mt-[20px] py-[50px] rounded-[10px]"
                ...
                <div className = "bg-white p-[20px] rounded-[10px] mt-[20px]" >
                        ...
                        <p className="pb-[5px]">{data ? `${data.length}` : 0} Data Portfolio</p>
