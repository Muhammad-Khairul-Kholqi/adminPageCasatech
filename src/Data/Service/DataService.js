...
//                             <p className="font-bold text-blue-600">{data ? `${data.length}` : 0} Data Services</p>
//                         </div>
//                     </div>

//                     <div>
//                         <Link to="/add-data-service">
                                ...
                                {paginateData().map((item) => (
                                    <tr key={item.id} className="text-[13px]">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex gap-[10px]">
                                                <Link to={`/edit-data-services/${item.id}`}>
                                                    <div className="icon-text text-[15px] flex justify-center gap-[5px] items-center text-blue-600 border border-blue-600 py-[3px] px-[5px] rounded-[3px]
